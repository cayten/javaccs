...
public class C03_Tasit {
    ...
    private   int yil;
    public String getTasitTuru() {return tasitTuru;}
    ...
    public boolean isMuayeneVarmi() {return MuayeneVarmi;}
    // boolean variable'lar icin olusturulan getter method'larinin ismi
    // isVariableIsmi() seklinde olur
    public void setMuayeneVarmi(boolean muayeneVarmi) {MuayeneVarmi = muayeneVarmi;}
